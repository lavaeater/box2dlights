...
public class DynamicShadowShader {
	...
	/** Simplified shadow shader used by the p3d package */
	static final public ShaderProgram createShadowShader(int colorReduction) {
		...
		final String fragmentShader = "#ifdef GL_ES\n"
				...
				+ "void main()\n"
				+ "{\n"
				+ "    gl_FragColor.rgb = (ambient.rgb + " + colorReduction + " * texture2D(u_texture, v_texCoords).rgb - texture2D(u_shadows, v_texCoords).rgb);\n"
				+ "}\n";
		ShaderProgram.pedantic = false;
